...
const createOperationIds = readOperationIds('zapierCreateOperationIds');
...
console.log(`Generated ${path.relative(root, testPath)} for ${fixtures.length} create operation(s).`);
